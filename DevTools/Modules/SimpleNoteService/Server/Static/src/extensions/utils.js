...
function showOperationBlock(h, unifiedPortalHost, operationId) {
...
export function renderErrorNotificationMessage(h, unifiedPortalHost, response) {
    if (response && response.data) {
        return h("div", null, [
            ...
            h("div", {style: "margin-top: 5px; margin-left: 5px"}, [
                showOperationBlock(h, unifiedPortalHost, response.data.operationId)
            ])
        ]);
    } else {
