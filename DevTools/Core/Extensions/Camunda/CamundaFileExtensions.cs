...
{
    internal static class CamundaFileExtensions
    {
        internal static string GetMimeType(this FileInfo file)
        {
            var extenstion = file.Extension.ToLowerInvariant();
            if (extenstion[0] == '.')
            {
                extenstion = extenstion.Remove(0, 1);
            }

            return MimeTypes.GetValueOrDefault(extenstion, "application/octet-stream");
        }
