...
using VXDesign.Store.DevTools.Common.Entities.Camunda.ProcessDefinition.Containers;
using VXDesign.Store.DevTools.Common.Enums.Camunda;

namespace VXDesign.Store.DevTools.Common.Entities.Camunda.ProcessDefinition.Models
{
